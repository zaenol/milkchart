...
/***********************************************
 *  MilkChart_src.js
 *  Graphing/chart tool for mootools 1.2.3
 *
...
MilkChart.Column = new Class({
    ...
    *********************************/
    ...
    drawKey: function() {
        ...
        textMarginLeft = 14;
        keyNameHeight = Math.ceil(this.height * .1);
...
MilkChart.Pie = new Class({
    ...
    *********************************/
    ...
    draw: function() {
        arcStart = 0;
        blah = 0;
        center = new Point(this.bounds[0].x + this.radius, this.bounds[0].y + this.radius);
